...
# stats [1:2] "with.transistor.dat" nooutput
stats "with.transistor.dat" using 2 nooutput
vce_min = STATS_min
vce_max = STATS_max
bjt_arrow_x_start = vce_max

stats "with.transistor.dat" using 3 nooutput
ib_min = STATS_min
ib_max = STATS_max
bjt_arrow_y_start = ib_min

stats "with.transistor.dat" using 4 nooutput
ic_min = STATS_min
ic_max = STATS_max
bjt_arrow_z_start = ic_min
set zrange [ic_min:ic_max]

stats "with.transistor.dat" using 5 nooutput
vdif_min = STATS_min
vdif_max = STATS_max
set cbrange [vdif_min:vdif_max]

stats "resistor.alone.dat" using 2 nooutput
res_arrow_x_start=STATS_median
stats "resistor.alone.dat" using 3 nooutput
res_arrow_y_start=STATS_median
stats "resistor.alone.dat" using 4 nooutput
...
set label 2 "resistor alone" at res_arrow_x_start, res_arrow_y_start, res_arrow_z_start*2 centre
...
splot "resistor.alone.dat" using 2:3:4 title "RESISTOR", \
	"with.transistor.dat" using 2:3:5 with pm3d at b title "VB-VC", \
	"with.transistor.dat" using 2:3:4 title "TRANSISTOR"
